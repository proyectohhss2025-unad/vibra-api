...
export class CreateConfigDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Habilita el módulo de pretest.',
  })
  @IsString()
  @IsOptional()
  description?: string;
  ...
  @ApiProperty({
    description: 'Valor de la bandera (feature flag).',
    example: true,
  })
  @IsBoolean()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({
    description:
      'Lista de usuarios permitidos (ids o usernames, según implementación).',
