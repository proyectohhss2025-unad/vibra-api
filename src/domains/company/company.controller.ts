...
export class CompanyController {
  ...
  @ApiBody({
    ...
    description: 'Datos para crear una compañía',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Número total de compañías obtenido exitosamente',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Compañía principal obtenida exitosamente',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'ID de compañía requerido o datos inválidos',
  })
  @ApiResponse({ status: 404, description: 'Compañía no encontrada' })
  @Patch()
  ...
  @ApiResponse({
    status: 200,
    description: 'Búsqueda de compañías completada exitosamente',
  })
  @Get('search')
  async search(
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        editedBy: {
          type: 'string',
          description: 'ID del usuario que realizó la edición',
        },
      },
    },
