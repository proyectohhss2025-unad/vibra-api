...
export class UpdateParticipantDto {
  ...
  @ApiPropertyOptional({
    description: 'Puntos acumulados (asignación directa).',
    example: 150,
  })
  @IsNumber()
  @IsOptional()
...
export class UpdatePointsDto {
  @ApiProperty({
    description: 'Puntos a incrementar (no absoluto).',
    example: 10,
  })
  @IsNumber()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Indica si completó una actividad.',
    example: true,
  })
  @IsBoolean()
