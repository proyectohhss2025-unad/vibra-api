...
import { FORMAT_DATE_SHORT, NOTIFICATION_CHANNEL_INBOX, NOTIFICATION_TYPE_ALERT, NOTIFICATION_TYPE_INFO } from '../../utils/constants';
...
export class AdminService {
    ...
    async generateBackups(user: any): Promise<string> {
        ...
        try {
            ...
            await this.notificationService.createGeneralNotification(message, 'Copia de seguridad exitosa', user);
    ...
    async deleteAllDocumentsByTest(): Promise<string> {
        try {
            ...
            try {
                ...
                this.logger.log('Los datos en las colecciones han sido borrados con exito.');
                ...
                this.logger.error(`Error eliminando Los datos en las colecciones.${error}`);
