...
mongoose.connect(db, options)
    .then(function () {
        logger.info('The connection to the MongoDB server has been established successfully!');
    }).catch(function (err) {
        logger.error("The connection to the MongoDB server could not be established!:", { err });
    });
